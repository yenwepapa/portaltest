...
@section('content')
	<div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Test Data <small>Edit form  </small></h2>
                ...
                <div class="x_content">
                  <br />
                  {!! Form::model($test_data, array('method' => 'PUT', 'route'=> array('test_data.update', $test_data->id),  'class'=>'form-horizontal')) !!} 

                    <div class="form-group @if ($errors->has('name')) has-error @endif">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" class="form-control col-md-7 col-xs-12" name="name" value="{{$test_data->name}}">
                    ...
                    <div class="form-group @if ($errors->has('mobile')) has-error @endif">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="last-name" name="mobile" class="form-control col-md-7 col-xs-12" value="{{$test_data->mobile}}">
                    ...
                    <div class="form-group @if ($errors->has('address')) has-error @endif">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control col-md-7 col-xs-12" name="address">{{$test_data->address}}</textarea>
                    ...
                    <div class="form-group @if ($errors->has('introduction')) has-error @endif">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control col-md-7 col-xs-12" name="introduction">{{$test_data->introduction}}</textarea>
                      </div>
                    </div>
