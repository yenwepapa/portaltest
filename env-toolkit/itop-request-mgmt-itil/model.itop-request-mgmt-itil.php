...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("contact_number", array("allowed_values"=>null, "sql"=>'contact_number', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("require_customer_input", array("allowed_values"=>new ValueSetEnum("yes,no"), "display_style"=>'list', "sql"=>'require_customer-input', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("closing_remarks", array("allowed_values"=>null, "sql"=>'closing_remarks', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDecimal("actual_time_spent", array("allowed_values"=>null, "sql"=>'actual_time_spent', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "digits"=>6, "decimals"=>2, "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'require_customer_input' => OPT_ATT_HIDDEN,
					'closing_remarks' => OPT_ATT_HIDDEN,
					'actual_time_spent' => OPT_ATT_HIDDEN,
				),
			)
		);
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'ttr_escalation_deadline' => OPT_ATT_HIDDEN,
					'require_customer_input' => OPT_ATT_MANDATORY | OPT_ATT_MUSTPROMPT,
				),
			)
		);
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'require_customer_input' => OPT_ATT_READONLY,
				),
			)
		);
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'require_customer_input' => OPT_ATT_READONLY,
					'closing_remarks' => OPT_ATT_MANDATORY,
					'actual_time_spent' => OPT_ATT_MANDATORY,
				),
			)
		);
