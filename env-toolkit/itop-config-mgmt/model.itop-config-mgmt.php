<?php
//
// File generated by ... on the 2016-04-27T09:51:32+0630
...
class Team extends Contact
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("shift_id", array("targetclass"=>'Shift', "allowed_values"=>new ValueSetObjects("SELECT Shift"), "sql"=>'shift_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
